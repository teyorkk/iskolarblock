...
import { useRenewalSubmission } from "@/hooks/use-renewal-submission";
...
export default function RenewalApplicationPage() {
  ...
  const eligibility = useRenewalEligibility({ userId: user?.id });
  ...
  if (eligibility.isCheckingEligibility) {
    return (
              ...
              <CardContent className="space-y-4">
                {eligibility.lockStatus && (
                  <p className="text-sm text-gray-600">
                    ...
                    <span className="font-semibold">{eligibility.lockStatus}</span>
                  </p>
                )}
  ...
  if (submission.isSubmitted && submission.submittedApplicationId) {
    return (
      <div className="min-h-screen bg-gray-50">
        <UserSidebar />
        <div className="md:ml-64 md:pt-20 pb-16 md:pb-0">
          <div className="p-4 md:p-6">
            <ApplicationSuccess
              applicationId={submission.submittedApplicationId}
          ...
          >
            ...
            >
              ...
              {currentStep === 2 && (
                <DocumentsUploadStep<RenewalApplicationFormData>
                  ...
                  getRootPropsRegistration={fileUploads.getRootPropsRegistration}
                  getInputPropsRegistration={fileUploads.getInputPropsRegistration}
                  isDragActiveRegistration={fileUploads.isDragActiveRegistration}
                  onRemoveGradesFile={fileUploads.handleRemoveGradesFile}
                  onRemoveRegistrationFile={fileUploads.handleRemoveRegistrationFile}
            ...
            <div className="flex justify-between mt-6">
              ...
              <Button
                onClick={
                  isLastStep
                    ? handleSubmit(submission.onSubmit)
                    : () => {
                ...
                disabled={
                  ...
                  (currentStep === 1 &&
                    (!fileUploads.uploadedFile || !fileUploads.isIdProcessingDone)) ||
                  (isLastStep && fileUploads.documentsProcessing)
                }
              >
                {submission.isSubmitting && isLastStep ? (
                  <>
